package app.zancord.manager.ui.screen.installer
...
import app.zancord.manager.ui.widgets.dialog.BackWarningDialog
import app.zancord.manager.ui.widgets.dialog.DownloadFailedDialog
import app.zancord.manager.ui.widgets.installer.StepGroupCard
...
class InstallerScreen(
    ...
    override fun Content() {
        ...
        val intentListener: (Intent) -> Unit = remember {
            {
                val msg = it.getStringExtra("zancord.extras.EXTRA_MESSAGE")
