package app.zancord.manager.installer.step
...
import app.zancord.manager.installer.step.installing.InstallStep
import app.zancord.manager.installer.step.patching.AddModStep
import app.zancord.manager.installer.step.patching.PatchManifestsStep
import app.zancord.manager.installer.step.patching.PresignApksStep
import app.zancord.manager.installer.step.patching.ReplaceIconStep
import app.zancord.manager.installer.util.LogEntry
import app.zancord.manager.installer.util.Logger
 ...
 *
 * @param discordVersion Version of Discord to inject Zancord into
 */
@Stable
class StepRunner(
